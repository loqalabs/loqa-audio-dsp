...
- [x] Write TypeScript tests in **tests**/computeFFT.test.ts (valid inputs, validation errors)
...
- Wrote comprehensive TypeScript tests in [**tests**/computeFFT.test.ts](__tests__/computeFFT.test.ts) covering all acceptance criteria
...
- [**tests**/computeFFT.test.ts](__tests__/computeFFT.test.ts) - Comprehensive TypeScript test suite (24 tests)
