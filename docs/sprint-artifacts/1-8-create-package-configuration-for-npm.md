...
- [x] Configure package.json for distribution (AC: #1)
  ...
  - [x] Add peerDependencies: expo (^54.0.0), react (_), react-native (_)
...
- [x] Create .npmignore file
  ...
  - [x] Exclude development files: **tests**, .github, example (if separate)
...
- .npmignore: Excludes development files (**tests**, .github, example, scripts, IDE files)
...
- ✅ peerDependencies: expo ^54.0.0, react _, react-native _ (exact match)
