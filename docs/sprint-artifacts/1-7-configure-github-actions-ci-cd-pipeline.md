...
- [x] Add package.json scripts needed by CI
  - [x] Ensure "lint" script exists: eslint src/**/*.ts
...
| Task | Marked As | Verified As | Evidence |
|------|-----------|-------------|----------|
| Ensure "lint" script exists: eslint src/**/*.ts | [x] Complete | ✅ VERIFIED | [file: package.json:36](../package.json#L36) - `"lint": "eslint . --ext .ts,.tsx"` |
