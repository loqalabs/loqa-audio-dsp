 ...
 * ```
 */
export async function calculateHNR(audioBuffer, options) {
    ...
    try {
        ...
        const nativeResult = await LoqaExpoDspModule.calculateHNR(bufferArray, options.sampleRate, nativeOptions);
...
//# sourceMappingURL=calculateHNR.js.map