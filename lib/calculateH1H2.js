 ...
 * ```
 */
export async function calculateH1H2(audioBuffer, options) {
    ...
    try {
        ...
        const nativeResult = await LoqaExpoDspModule.calculateH1H2(bufferArray, options.sampleRate, nativeOptions);
...
//# sourceMappingURL=calculateH1H2.js.map